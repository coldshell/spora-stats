#!/usr/bin/octave
csv_office = dlmread("../../csv/office-19286-82050-bisect.csv", ";");
csv_pdf = dlmread("../../csv/pdf-19286-82050-bisect.csv", ";");
csv_autocad = dlmread("../../csv/autocad-23000-96000-bisect.csv", ";");
csv_db = dlmread("../../csv/db-27500-118000-bisect.csv", ";");
